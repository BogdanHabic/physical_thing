...
;ReadWrite_Routines.c,121 :: 		void write_TX_normal_FIFO() {
SUB	SP, SP, #4
STR	LR, [SP, #0]
;ReadWrite_Routines.c,122 :: 		int i = 0;
;ReadWrite_Routines.c,124 :: 		data_TX_normal_FIFO[0]  = HEADER_LENGHT;
MOVS	R1, #11
SXTB	R1, R1
MOVW	R0, #lo_addr(_data_TX_normal_FIFO+0)
MOVT	R0, #hi_addr(_data_TX_normal_FIFO+0)
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,125 :: 		data_TX_normal_FIFO[1]  = HEADER_LENGHT + DATA_LENGHT;
MOVS	R1, #12
SXTB	R1, R1
MOVW	R0, #lo_addr(_data_TX_normal_FIFO+1)
MOVT	R0, #hi_addr(_data_TX_normal_FIFO+1)
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,126 :: 		data_TX_normal_FIFO[2]  = 0x01;                        // control frame
MOVS	R1, #1
SXTB	R1, R1
MOVW	R0, #lo_addr(_data_TX_normal_FIFO+2)
MOVT	R0, #hi_addr(_data_TX_normal_FIFO+2)
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,127 :: 		data_TX_normal_FIFO[3]  = 0x88;
MOVS	R1, #136
SXTB	R1, R1
MOVW	R0, #lo_addr(_data_TX_normal_FIFO+3)
MOVT	R0, #hi_addr(_data_TX_normal_FIFO+3)
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,128 :: 		data_TX_normal_FIFO[4]  = SEQ_NUMBER;                  // sequence number
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,129 :: 		data_TX_normal_FIFO[5]  = PAN_ID_2[1];                 // destinatoin pan
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,130 :: 		data_TX_normal_FIFO[6]  = PAN_ID_2[0];
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,131 :: 		data_TX_normal_FIFO[7]  = ADDRESS_short_2[0];          // destination address
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,132 :: 		data_TX_normal_FIFO[8]  = ADDRESS_short_2[1];
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,133 :: 		data_TX_normal_FIFO[9]  = PAN_ID_1[0];                 // source pan
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,134 :: 		data_TX_normal_FIFO[10] = PAN_ID_1[1];
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,135 :: 		data_TX_normal_FIFO[11] = ADDRESS_short_1[0];          // source address
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,136 :: 		data_TX_normal_FIFO[12] = ADDRESS_short_1[1];
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,137 :: 		data_TX_normal_FIFO[13] = DATA_TX[0];                  // data
...
STRB	R1, [R0, #0]
;ReadWrite_Routines.c,139 :: 		for(i = 0; i < (HEADER_LENGHT + DATA_LENGHT + 2); i++) {
; i start address is: 24 (R6)
MOVS	R6, #0
SXTH	R6, R6
; i end address is: 24 (R6)
...
;ReadWrite_Routines.c,140 :: 		write_ZIGBEE_long(address_TX_normal_FIFO + i, data_TX_normal_FIFO[i]); // write frame into normal FIFO
MOVW	R0, #lo_addr(_data_TX_normal_FIFO+0)
MOVT	R0, #hi_addr(_data_TX_normal_FIFO+0)
ADDS	R0, R0, R6
LDRSB	R0, [R0, #0]
...
ADDS	R6, R6, #1
SXTH	R6, R6
;ReadWrite_Routines.c,141 :: 		}
; i end address is: 24 (R6)
IT	AL
BAL	L_write_TX_normal_FIFO5
L_write_TX_normal_FIFO6:
;ReadWrite_Routines.c,143 :: 		set_not_ACK();
BL	_set_not_ACK+0
;ReadWrite_Routines.c,144 :: 		set_not_encrypt();
BL	_set_not_encrypt+0
;ReadWrite_Routines.c,145 :: 		start_transmit();
BL	_start_transmit+0
;ReadWrite_Routines.c,146 :: 		}
